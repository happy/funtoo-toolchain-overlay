...
src_prepare() {
	...
	if ! use vanilla; then
		...
		# GCC bug https://gcc.gnu.org/bugzilla/show_bug.cgi?id=61144
		# This patch is not included in Gentoo's patchset ver 1.1
		cat "${FILESDIR}"/gcc-4.9-pr61144.patch | patch -p1 || die "patch fail"
